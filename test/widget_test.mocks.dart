...
import 'package:myapp/helpers/database_helper.dart' as _i5;
import 'package:myapp/models/user_model.dart' as _i4;
...
class MockDatabaseHelper extends _i1.Mock implements _i5.DatabaseHelper {
  ...
  @override
  _i6.Future<void> insertUser(_i4.User? user) =>
      (super.noSuchMethod(
...
class MockAuthService extends _i1.Mock implements _i7.AuthService {
  ...
  _i6.Future<_i4.User> login(
    ...
    String? imei,
      ...
      (super.noSuchMethod(
            Invocation.method(#login, [username, password, imei]),
            returnValue: _i6.Future<_i4.User>.value(
              _FakeUser_2(
                this,
                Invocation.method(#login, [username, password, imei]),
